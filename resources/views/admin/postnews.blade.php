  ...
  <body>
    <div class="container-scroller">
     ...
     <div class="container-fluid page-body-wrapper">
      ...
      @endif  
      <h2 style="font-size:27px;margin-bottom:10px;"><span style="color:#00cc7a">Add Post</span> Information</h2> 
     ...
     @csrf
        ...
        <div style="padding:15px">
          ...
          <select name="catagory" style="color:black">
          <option >---Select catagory Here</option>
